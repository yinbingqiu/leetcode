 ...
 */
public class 非连续最长递增子序列长度 {

    public static void main(String[] args) {
//        System.out.println(lengthOfLongestIncrementSeq(new int[]{10, 9, 2, 5, 3, 7, 21, 18}));
//        System.out.println(lengthOfLongestIncrementSeq(new int[]{1,3,6,7,9,4,10,5,6}));
        System.out.println(lengthOfLongestIncrementSeq(new int[]{2,1,5,3,6,4,8,9,7}));
    }

    public static int lengthOfLongestIncrementSeq(int[] nums) {
